@extends('layouts.app')
@section('navbarTitel', 'Production Order')
@section('content')
    ...
    <form  id="productionOrderEditForm" action="{{ route('production_order.update', $productionOrder->id) }}" method="post">
        ...
        <div class="outer card">
            <div class="heading-btn">
                <span class="addsupplier-section-heading">Edit the production program</span>
                ...
                <div class="row customer-files-sec"> 
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <select class="form-control select2 form-select-grp @error('product_type') is-invalid @enderror @if(old('product_type')) is-valid @endif" name="product_type" id="product_type">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('pending_bundle_quantity') is-invalid @enderror @if(old('pending_bundle_quantity')) is-valid @endif" name="pending_bundle_quantity" id="pending_bundle_quantity" placeholder="Pending Bundle Quantity" value="{{ old('pending_bundle_quantity', $productionOrder->pending_bundle_qty ?? '') }}">
                        ...
                        <div class="col-lg-4 mb-3">
                            <label class="heading-content" for="bundle_quantity">Bundle Quantity</label>
                            <input type="text" class="form-control @error('bundle_quantity') is-invalid @enderror @if(old('bundle_quantity')) is-valid @endif" name="bundle_quantity" id="bundle_quantity" placeholder="Bundle Quantity" value="{{ old('bundle_quantity', $productionOrder->bundle_quantity) }}">
                ...
                <div class="row customer-files-sec">
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <input type="text" class="form-control @error('lamination_internal_notes') is-invalid @enderror @if(old('lamination_internal_notes')) is-valid @endif" name="lamination_internal_notes" id="lamination_internal_notes" value="{{ old('lamination_internal_notes',$productionOrder->lamination_internal_notes ?? '') }}" placeholder="Lamination Extrusion Internal Notes">
                ...
                <div class="row customer-files-sec">
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <input type="text" class="form-control @error('extrusion_internal_notes') is-invalid @enderror @if(old('extrusion_internal_notes')) is-valid @endif" name="extrusion_internal_notes" id="extrusion_internal_notes" placeholder="Quantity of Packing" value="{{ old('extrusion_internal_notes', $productionOrder->extrusion_internal_notes) }}">
                    ...
                    <div class="row customer-files-sec">
                        <div class="row form-inp-group">
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('rewinding_internal_notes') is-invalid @enderror @if(old('rewinding_internal_notes')) is-valid @endif" name="rewinding_internal_notes" id="rewinding_internal_notes" placeholder="Length" value="{{ old('rewinding_internal_notes', $productionOrder->rewinding_internal_notes) }}">
        ...
        <div class="outer card" id="packingDetails">
                ...
                <hr class="addsupplier-section-border">
                <h6 class="prdctn-odr-heading">Step 3 - packing Details</h6>
                <div class="upload-file-sec">
                    <div class="row customer-files-sec">
                        <div class="row form-inp-group">
                            <div class="col-lg-3 mb-3">
                                <label class="heading-content" for="packing_bharti">Bharti<span style="color: red;">*</span></label>
                                <input type="text" class="form-control @error('packing_bharti') is-invalid @enderror @if(old('packing_bharti')) is-valid @endif" name="packing_bharti" id="packing_bharti" placeholder="Length" value="{{ old('packing_bharti', $productionOrder->packing_bharti) }}">
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('packing_internal_notes') is-invalid @enderror @if(old('packing_internal_notes')) is-valid @endif" name="packing_internal_notes" id="packing_internal_notes" value="{{ old('packing_internal_notes',$productionOrder->packing_internal_notes??'') }}" placeholder="Packing Internal Notes">
        ...
        <div class="outer card" id="stitchingproduction">       
                <h6 class="prdctn-odr-heading">Step 4 - Stitching</h6>
                <hr class="addsupplier-section-border">
                <div class="upload-file-sec">
                    <div class="row customer-files-sec">
                        <div class="row form-inp-group">
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('Stitching_internal_notes') is-invalid @enderror @if(old('Stitching_internal_notes')) is-valid @endif" name="Stitching_internal_notes" id="Stitching_internal_notes" value="{{ old('Stitching_internal_notes',$productionOrder->Stitching_internal_notes??'') }}" placeholder="Stitching Internal Notes">
                    ...
                    <div class="row customer-files-sec">
                        <div class="row form-inp-group">
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('start_date') is-invalid @enderror @if(old('start_date')) is-valid @endif" name="start_date" id="start_date" value="{{ old('start_date', $productionOrder->start_date) }}">
                                @error('start_date')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('internal_notes') is-invalid @enderror @if(old('internal_notes')) is-valid @endif" name="internal_notes" id="internal_notes" value="{{ old('internal_notes', $productionOrder->internal_notes) }}">
...
//         var packagingGuageInput = document.getElementById('packing_gauge');
...
//         // Convert productsData to an object with product ID as the key
...
//             skuInput.value = productData.alias_sku || '';
...
//         // Trigger change event to set the fields if there's a pre-selected product
...
//     const makeToOrderCustomerName = document.getElementById('make_to_order_customer_name');
        ...
        if (materialId) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        console.log('Material Name:', response.name); // Log the material name
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    companyNameSelect.addEventListener('change', function () {
            ...
            if (selectedCompanyId) {
                ...
                success: function(response) {
                    ...
                    response.orders.forEach((order, orderIndex) => {
                        var salesOrderOption = document.createElement('option');
                        ...
                        // Adjust based on your order fields
                        // salesOrderOption.setAttribute('data-sticker', order.product_orders[orderIndex].sticker_name);
                        // salesOrderOption.setAttribute('data-colour', order.product_orders[orderIndex].colour);
                        // salesOrderOption.setAttribute('data-bdl', order.product_orders[orderIndex].bdl_kg);
                        // salesOrderOption.setAttribute('data-remark', firstProductOrder.remark || '');
                        if (order.product_orders && order.product_orders.length > 0) {
                            var firstProductOrder = order.product_orders[0];
                            console.log('*************');
                            ...
                            salesOrderOption.setAttribute('data-bdl', firstProductOrder.bdl_kg || '');
                            salesOrderOption.setAttribute('data-remark', firstProductOrder.remark || '');
                        } else {
                            salesOrderOption.setAttribute('data-sticker', '');
                            salesOrderOption.setAttribute('data-colour', '');
                            salesOrderOption.setAttribute('data-bdl', '');
                            salesOrderOption.setAttribute('data-remark', '');
                        }
                        ...
                        productTypeSelect.innerHTML = '<option value="">Select Productcxvcxv</option>';
    ...
    $.validator.addMethod("checkPendingBundleLessThanQtyRequired", function(value, element) {
        var qtyRequired = Number($('#qty_required').val());
        return value <= qtyRequired;
    }, "Pending bundle quantity must be less than qty required.");
    $("#productionOrderEditForm").validate({
        ...
        pending_bundle_quantity: {
            required: true,
            // digits: true, 
            checkQtyRequiredFilled: true, 
            checkPendingBundleLessThanQtyRequired: true
        },
            sku: {
                required: true,
                maxlength: 255,
        ...
        messages: {
            ...
            sales_order: {
                required: "Please select a valid sales order number.",
                maxlength: "Sales Order cannot exceed 255 characters.",
            },
            qty_required: {
                required: "Please enter a valid bundle quantity.",
                digits: "Please enter a valid integer.",
            },
            pending_bundle_quantity: {
            required: "Please enter a valid pending bundle quantity.",
            ...
            sku: {
                required: "Please select a valid sku.",
                maxlength: "SKU cannot exceed 255 characters.",
            },
            extrusion_gauge: {
                required: "Please enter a valid extrusion gauge.",
            ...
            extrusion_size: {
                required: "Please enter a valid extrusion size.",
                maxlength: "Extrusion Size cannot exceed 255 characters.",
            },
            extrusion_recipe: {
                required: "Please enter a valid extrusion recipe.",
                maxlength: "Extrusion Recipe cannot exceed 255 characters.",
            },
            extrusion_qty_of_packing: {
                required: "Please enter a valid extrusion quantity of packing.",
                digits: "Please enter a valid integer.",
            },
            rewinding_pipe: {
                required: "Please enter a valid rewinding pipe.",
                maxlength: "Rewinding Pipe cannot exceed 255 characters.",
            },
            rewinding_sticker: {
                required: "Please enter a valid rewinding sticker.",
                maxlength: "Rewinding Sticker cannot exceed 255 characters.",
            },
            rewinding_qty_in_rolls: {
                required: "Please enter a valid rewinding quantity in rolls.",
                digits: "Please enter a valid integer.",
            },
            rewinding_colour: {
                required: "Please enter a valid rewinding colour.",
                maxlength: "Rewinding Colour cannot exceed 255 characters.",
            },
            rewinding_width: {
                required: "Please enter a valid rewinding width.",
           ...
           // },
            rewinding_length: {
                required: "Please enter a valid rewinding length.",
            ...
            packing_width: {
                required: "Please enter a valid packing width.",
                maxlength: "Packing Width cannot exceed 255 characters.",
            },
            packing_length: {
                required: "Please enter a valid packing length.",
                maxlength: "Packing Length cannot exceed 255 characters.",
            },
            packing_bharti: {
                required: "Please enter a valid packing bharti.",
                maxlength: "Packing Bharti cannot exceed 255 characters.",
            },
            packing_name: {
                required: "Please enter a valid packing name.",
            ...
            packing_carton: {
                required: "Please enter a valid packing carton.",
            ...
            packing_outer_name: {
                required: "Please enter a valid packing outer name.",
                maxlength: "Packing Outer Name cannot exceed 255 characters.",
            },
            packing_qty_rolls: {
                required: "Please enter a valid packing qty rolls.",
                digits: "Please enter a valid integer.",
            },
            packing_qty_bundle: {
            ...
            sticching_product_name: {
                required: "Please enter a valid stitching product name.",
                maxlength: "Stitching Product Name cannot exceed 255 characters.",
            },
            sticching_colour: {
                required: "Please enter a valid stitching product colour.",
                maxlength: "Stitching Colour cannot exceed 255 characters.",
            },
            sticching_packing_name: {
                required: "Please enter a valid stitching packing name.",
                maxlength: "Stitching Packing Name cannot exceed 255 characters.",
            },
            sticching_packing_type: {
                required: "Please enter a valid stitching packing type.",
                maxlength: "Stitching Packing Type cannot exceed 255 characters.",
            },
            sticching_qty_bundle: {
                required: "Stitching Quantity in Bundle is required.",
                digits: "Please enter a valid integer.",
            },
            sticching_bharti: {
                required: "Stitching Bharti is required.",
                maxlength: "Stitching Bharti cannot exceed 255 characters.",
            },
            sticching_qty_rolls: {
                required: "Stitching Quantity in Rolls is required.",
                digits: "Please enter a valid integer.",
            },
            sticching_bag: {
                required: "Please enter a valid stitching bag/box.",
    ...
    $.validator.addMethod("greaterThanToday", function(value, element) {
        ...
        }, "The Start date must be greater than today's date.");
});
// $(document).ready(function () {
//     $("#productionOrderEditForm").validate({
//         rules: {
