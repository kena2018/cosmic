...
RUN git clone https://github.com/kena2018/cosmic.git
...
# Copy Nginx configuration from clp_configuration
COPY clp_configuration/nginx.conf /etc/nginx/sites-available/default
