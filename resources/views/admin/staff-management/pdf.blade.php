...
<html>
<head>
<title>Staff Management PDF</title>
<style>
    *{font-family: sans-serif;}
    ...
    .no-data {border: 1px solid #9b9b9b;padding: 10px 8px 10px 10px;text-align:center;}
</style>
</head>
<body>
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Staff Management</div>
        ...
        <div class="section-heading first-section-heading">Staff Management Information</div>
        <table class="info-table first-tablee">
            ...
            <tr>
                <th class="table-heading-sec">Phone:</th>
                <td>{{ $user->contect }}</td>
            </tr>
        </table>
        ...
        <table class="info-table first-tablee">
            <tr>
                ...
                <th class="table-heading-sec">Role Name:</th>
                <td>{{ $role->name }}</td>
                @endforeach
            </tr>
        </table>
        <div class="section-heading">Permissions Details</div>
        <table class="info-table first-tablee">
            ...
            <tr>  
                ...
                @empty
                <td class="no-data">No permissions available</td>
            </tr>
            @endforelse
        </table>
