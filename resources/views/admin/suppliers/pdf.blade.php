...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Supplier</div>
        ...
        <div class="section-heading first-section-heading">Company Details</div>
        ...
        <tr>
            <th class="table-heading-sec">GST Number:</th>
            <td> {{ $supplier->gst_number }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">GST Type:</th>
            <td>{{ $supplier->gst_type }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Email:</th>
            <td>{{ $supplier->email_cmp }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Phone No.:</th>
            <td>{{ $supplier->contect_cmp }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Address:</th>
            <td>{{ $supplier->address1 }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">City:</th>
            <td>{{ optional($cities->find($supplier->city))->name }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">State:</th>
            <td>{{ optional($states->find($supplier->state))->name }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Pincode:</th>
            <td>{{ $supplier->pincode }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Country:</th>
            <td>{{ optional($countries->find($supplier->country))->name }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Material:</th>
            <td> {{ optional($materials->find($supplier->material))->material_name }}</td>
        </tr>
        </table>
        <div class="section-heading">Contact Person Details</div>
        <table class="info-table first-tablee">
        <tr>
            <th class="table-heading-sec">Name:</th>
            <td>{{ $supplier->name }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Email:</th>
