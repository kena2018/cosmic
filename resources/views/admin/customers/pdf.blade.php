...
<html>
<head>
<title>Customers Summery PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Customers Summery</div>
        ...
        <div class="section-heading first-section-heading">Company and Billing Information</div>
        <table class="info-table first-tablee">
            ...
            <tr>
                <th class="table-heading-sec">GSTIN:</th>
                <td>{{ $customer->gstin }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Payment Terms:</th>
                <td>{{ $customer->payment_terms }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Billing Address Line 1:</th>
                <td>{{ $customer->address1 }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Billing Address Line 2:</th>
            ...
            <tr>
                <th class="table-heading-sec">Pin:</th>
                <td>{{ $customer->pin }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="table-heading-sec">Group:</th>
                <td>{{optional($groups->find($customer->group))->name}}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Perf. Matrix:</th>
                <td>{{old('matrix',$customer->matrix ?? '')}}</td>
            </tr>
        </table>
        <div class="section-heading">Personal Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec">First Name:</th>
                <td>{{ $customer->first_name }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Last Name:</th>
