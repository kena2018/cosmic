...
<html>
<head>
<title>Permission Details PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Permission</div>
        ...
        <div class="section-heading first-section-heading">Permission Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec">Permission Name:</th>
