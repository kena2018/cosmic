@extends('layouts.app')
@section('navbarTitel', 'Role Create')
@section('content')
<style>
    button:focus {
    ...
    <div class="main-outer">
        <div class="outer card">
            <form class="needs-validation" action="{{ route('roles.store')}}" method="post" novalidate id="addRole">
                <div class="heading-btn">
                    <span class="addsupplier-section-heading">Role Create</span>
                ...
                <div class="row form-inp-groups">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control input-form-content @error('name') is-invalid @enderror @if(!empty(old('name'))) is-valid @endif" name="name" id="name" placeholder="Role Name" value="{{old('name')}}" required >
                        ...
                        <div class="row form-inp-groupss">
                            ...
                            <div class="permission-content">
                                ...
                                <div class="permission-sec">
                                    <input type="checkbox" name="permissions[]" id="permission_{{ $permission->id }}" value="{{ $permission->id }}" class="name permission-checkbox">
