...
<style>
    *{font-family: sans-serif;}
    ...
    .info-table td {font-size: 14px;padding: 10px 8px 10px 10px; text-align: left; font-weight: 600; color: #222222;border-right: 1px solid #9b9b9b;border-left: 1px solid #9b9b9b;}
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Role</div>
        ...
        <div class="section-heading first-section-heading">Role Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec role-sec">Role Name:</th>
                <td>{{ $role->name }}</td>
            </tr>
        </table>
        ...
        <table class="info-table first-tablee">
            <thead>
                <tr>
                    <th class="table-heading-sec role-sec">Permission Name</th>
                    <th class="table-heading-sec role-sec">Status</th>
                </tr>
            </thead>
            <tbody>
                @foreach($permissions as $permission)
                    <tr>
                        ...
                        <td>{{ in_array($permission->id, $rolePermissions) ? 'Granted' : 'Not Granted' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
