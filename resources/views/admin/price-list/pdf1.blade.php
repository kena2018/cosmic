...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Group Pricing</div>
        ...
        <div class="section-heading first-section-heading">Group Pricing Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec">List Name:</th>
                <td>{{ $priceList->list_name }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Discount(%):</th>
        ...
        <table class="info-table first-tablee">
            ...
            <tr>
                ...
                <td>{{ optional($products->find($PriceListItem->product_id))->product_name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Min QTY:</th>
                <td>{{ $PriceListItem->min_qty }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Rate:</th>
                <td>{{ $PriceListItem->rate }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Discount Rate:</th>
                <td>{{ $PriceListItem->discount_rate }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Special Rate:</th>
                <td>{{ $PriceListItem->special_rate }}</td>
            </tr>
            @endforeach
        </table>
