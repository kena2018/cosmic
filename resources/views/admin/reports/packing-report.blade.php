...
<div class="main-outer">
    ...
    <div class="upload-file-sec">
        ...
        <div class="icon-tab-btn">
            ...
            <div class="btn-sec btn_group">
                <a href="{{ route('reports.packing.pdf') }}" target="_blank">
    ...
    <div class="outer card">
        <div class="upload-file-sec customer-list-sec">
            <h6 class="addsupplier-section-heading">Packing orders list</h6>
        </div>
    ...
    <thead>
            ...
            <th>Labour Name</th>
            <th>Bags Per Box Quantity</th>
            <th>Steping Required</th>
            <th>Action</th>
        </thead>
    </table>
</div>
...
$(document).ready(function() {
    $('#rewindingTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('reports.packing') }}", // Use the route to get data via AJAX
        columns: [
            { data: 'date', name: 'date' },
            ...
            { data: 'bags_per_box_qty', name: 'bags_per_box_qty' },
            { data: 'steping_required', name: 'steping_required' },
