...
<html>
<head>
<title>Rewinding Report PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Rewinding Report</div>
        ...
        <div class="section-heading first-section-heading">Rewinding Report Information</div>
        <table class="info-table first-tablee">
        @foreach($rewindingData as $data)
        <tr>
        ...
        <tr>
            <th class="table-heading-sec">Contractor</th>
            <td>{{ $data->contractor }}</td>
        </tr>
        <tr>
            <th class="table-heading-sec">Rolls</th>
            <td> {{ $data->rolls }}</td>
        </tr>
        <tr>
