...
<html>
<head>
<title>Lamination Report PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Extruder Report</div>
        ...
        <div class="section-heading first-section-heading">Lamination Report Information</div>
        <table class="info-table first-tablee">
            ...
            <tr>
                <th class="table-heading-sec">Completed quantity</th>
                <td>{{ $data->this_orders_completed_quantity }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="table-heading-sec">Meter</th>
                <td>{{ $data->meter }}</td>
            </tr>
            <tr>
