...
<html>
<head>
<title>Stock Outward Reports PDF</title>
<style>
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Stock Outward Reports</div>
                    <div class="project-date">Date: {{ $Outwarddata[0]['date'] }}</div>
                </td>
            </tr>
        </table>
        <div class="section-heading first-section-heading">Outward Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec">User Name:</th>
                <td>{{ $Outwarddata[0]['user']['name']; }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Date:</th>
                <td>{{ $Outwarddata[0]['date'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Machine:</th>
                <td>{{ $Outwarddata[0]['machine'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Material Name:</th>
                <td>{{ $Outwarddata[0]['material']['material_name'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Category:</th>
                <td>{{ $Outwarddata[0]['category']['name'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Sub Category:</th>
                <td>{{ $Outwarddata[0]['materialSubCategory']['sub_cat_name'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">unit1:</th>
                <td>{{ $Outwarddata[0]['unit1'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">unit1 Value:</th>
                <td>{{ $Outwarddata[0]['unit1_value'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">unit2:</th>
                <td>{{ $Outwarddata[0]['unit2'] }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">unit2 Value:</th>
                <td>{{ $Outwarddata[0]['unit2_value'] }}</td>
            </tr>
        </table>
