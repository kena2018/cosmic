@extends('layouts.app')
@section('navbarTitel', 'Reports - Rewinding Report')
@section('content')
<style>
...
<div class="main-outer">
    ...
    <div class="upload-file-sec">
        ...
        <div class="icon-tab-btn">
            ...
            <a href="{{ route('reports.rewinding.pdf') }}" target="_blank">
...
<!-- 
    ...
    <div class="outer card">
        <div class="upload-file-sec customer-list-sec">
            <h6 class="addsupplier-section-heading">Rewinding orders list</h6>
        </div>
...
$(document).ready(function() {
    $('#rewindingTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('reports.rewinding') }}", // Use the route to get data via AJAX
        columns: [
            { data: 'date', name: 'date' },
