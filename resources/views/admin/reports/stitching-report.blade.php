@extends('layouts.app')
@section('navbarTitel', 'Reports - Silai Report')
@section('content')
<style>
...
<div class="main-outer">
    ...
    <div class="upload-file-sec">
        ...
        <div class="icon-tab-btn">
            ...
            <div class="btn-sec btn_group">
                <a href="{{ route('reports.stitching.pdf') }}" target="_blank">
                    <span class="report-print-icon report-print-icon-tag"></span>
                </a>
            </div>
            <div class="btn-sec btn_group">
            <!-- <a href="" class="btn-sm m-1" target="_blank"><i class="files-group-icons files-icon-tag"></i></a> -->
    ...
    <div class="outer card">
        <div class="upload-file-sec customer-list-sec">
            <h6 class="addsupplier-section-heading">Silai orders list</h6>
        </div>
...
$(document).ready(function() {
    $('#rewindingTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('reports.stitching') }}", // Use the route to get data via AJAX
        columns: [
            { data: 'date', name: 'date' },
            ...
            { data: 'bundle_qty', name: 'bundle_qty' },
            { data: 'qty_per_bdl', name: 'qty_per_bdl' },
