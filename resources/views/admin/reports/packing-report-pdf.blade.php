...
<html>
<head>
<title>Packing Report PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Packing Report</div>
        ...
        <div class="section-heading first-section-heading">Packing Report Information</div>
        <table class="info-table first-tablee">
            ...
            <tr>
                <th class="table-heading-sec">Sales Order ID</th>
                <td>{{ $data->sales_order_id }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Production Order ID</th>
                <td>{{ $data->production_order_id }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Customer Name</th>
            ...
            <tr>
                <th class="table-heading-sec">Status</th>
                <td>{{ ucfirst($data->status) }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Quantity Required</th>
                <td>{{ $data->bundle_quantity }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Labour Name</th>
                <td>{{ $data->labour_name }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Bundle Quantity</th>
                <td>{{ $data->bags_per_box_qty }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Quantity per Bundle</th>
                <td> {{ $data->steping_required }}</td>
            </tr>
            <tr class="end-sec">
                <th class="table-heading-sec"> </th>
                <td> </td>
            </tr>
            @endforeach
        </table>
