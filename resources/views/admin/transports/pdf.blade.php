...
<html>
<head>
<title>Transport Details PDF</title>
<style>
...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Transport</div>
        ...
        <div class="section-heading first-section-heading">Transport Information</div>
        <table class="info-table first-tablee">
            ...
            <tr>
                ...
                <td> {{ $transports->phone }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Location:</th>
                <td>{{ $transports->location }}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Pin:</th> 
                <td>{{ $transports->pin }}</td> 
            </tr>
        </table>
