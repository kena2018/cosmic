...
<div class="pdf-container">
    ...
    <div class="data-container">
        <table class="header-table">
            <tr>
                ...
                <td class="project_data">
                    <div class="project-title">Lamination</div>
        ...
        <div class="section-heading first-section-heading">Lamination Information</div>
        <table class="info-table first-tablee">
            <tr>
                <th class="table-heading-sec">Paper Name:</th>
                <td>{{old('paper_name',$laminnations->paper_name ?? '')}}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Lamination Name:</th>
                <td>{{old('lamination_name',$laminnations->lamination_name ?? '')}}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Gum Name:</th>
                <td>{{old('gum_name',$laminnations->gum_name ?? '')}}</td>
            </tr>
            <tr>
                <th class="table-heading-sec">Lamination Type:</th> 
                <td>{{old('lamination_type',$laminnations->lamination_type ?? '')}}</td> 
            </tr>
        </table>
