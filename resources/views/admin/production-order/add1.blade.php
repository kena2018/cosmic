                ...
                <div class="row customer-files-sec">
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <!-- <input type="text" class="form-control @error('extrusion_recipe') is-invalid @enderror @if(old('extrusion_recipe')) is-valid @endif" name="extrusion_recipe" id="extrusion_recipe" placeholder="Recipe" value="{{ $formattedLastOrderId }}" readonly>
                    ...
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="rewinding_sticker" name="rewinding_sticker">
                                <option value="">Select</option>
                                @foreach($stickers as $sticker)
                                    <option value="{{$sticker->material_name}}"  data-id="{{$sticker->id}}"{{ old('rewinding_sticker') == $sticker->id ? 'selected' : '' }}>{{$sticker->material_name}}</option>
                                @endforeach
                            </select>
            ...
            <div class="upload-file-sec">
                <div class="row customer-files-sec">
                    <div class="row form-inp-group">
                        ...
                        <!-- <div class="col-lg-3 mb-3">
                            <label class="heading-content"  for="category">Packing Name</label>
                            <select name="packing_name" id="packing_name" class="custom-select d-block w-100 form-select-grps form-control select2">
                                <option class="option-desgn" value="" hidden>Select Gum Name</option>
                                @foreach($materials as $material)
                                    <option value="{{ $material->id }}" {{ old('packing_name') == $material->id ? 'selected' : '' }}>{{ $material->material_name }}</option>
                                @endforeach  
                            </select>
                        ...
                        <div class="col-lg-3 mb-3" >
                            ...
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="packing_name" name="packing_name">
                                <option value="">Select</option>
                                @foreach($materials as $material)
                                    <option value="{{$material->material_name}}"  data-id="{{$material->id}}"{{ old('packing_name') == $sticker->id ? 'selected' : '' }}>{{$material->material_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="packing_sticker" name="packing_sticker">
                                <option value="">Select</option>
                                @foreach($stickers as $sticker)
                                    <option value="{{$sticker->material_name}}"  data-id="{{$sticker->id}}"{{ old('packing_sticker') == $sticker->id ? 'selected' : '' }}>{{$sticker->material_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="sticching_packing_name" name="sticching_packing_name">
                                <option value="">Select</option>
                                @foreach($materials as $material)
                                    <option value="{{$material->material_name}}"  data-id="{{$material->id}}"{{ old('sticching_packing_name') == $sticker->id ? 'selected' : '' }}>{{$material->material_name}}</option>
                                @endforeach
                            </select>
...
// console.log('color');
    ...
    if (response.orders && response.orders.length > 0) {
        ...
        response.orders.forEach(order => {
            ...
            //     // console.log('data2323223');
            //     // console.log(firstProductOrder.colour);
            ...
            //         console.log(productOrder.colour);

            //         // Set attributes on the salesOrderOption element for each productOrder
            //         salesOrderOption.setAttribute('data-sticker', productOrder.sticker_name || '');
            //         salesOrderOption.setAttribute('data-colour', productOrder.colour || '');
            //         salesOrderOption.setAttribute('data-remark', productOrder.remark || '');
            //     });
            // }
    ...
    if (selectedProductId) {
        $.ajax({
            ...
            success: function (response) {
                ...
                //extrusionQtyOfPackingInput.value =((packingWeightVal * rollsInOneBDL *response.requiredData).toFixed(2));
                ...
                // rewindingStickerInput.value = response.sticker_name;
                // packingStickerInput.value = response.sticker_name;
                // const colourValue = response.colour || "";
                // rewindingColourInput.value = colourValue;
                // stitchingColourInput.value = colourValuer;
                ...
                if(category == '1' || category == '2' || category == '5'){
                    console.log('color check data category',category);
                    rewindingColourInput.value = '' ;
                    stitchingColourInput.value = '' ;
                    packingColourInput.value = '' ;
                    ...
                    packingColourInput.value = response.colour || "" ;
                    extrusionColourInput.value = response.colour || "" ;
                    console.log('color check data',category);
