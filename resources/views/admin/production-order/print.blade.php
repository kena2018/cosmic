...
<div class="form-container">
    ...
    <div class="personal-info">
        ...
        <div class="row">
            <p class="field-size"><strong>Required Bundle Quantity:</strong> {{ old('bundle_quantity', $productionOrder->bundle_quantity??'N/A') }}</p>
        </div>
    </div>
    ...
    <?php if ($categoryValue === 'Paper Roll' || $categoryValue === 'Paper Sheet' || $categoryValue === 'Paper Jumbo Roll'): ?>
        <div class="personal-info details-space" id="laminationProduction">
            <h6 class="prdctn-odr-heading">Step 1 - Lamination</h6>
            <div class="row first-section">
                <p class="field-size"><strong>Paper Name:</strong> {{ optional($materials->find($productionOrder->lamination_paper_name))->material_name ?? 'N/A' }}</p>
                <p class="field-size"><strong>Lamination Name:</strong>{{ optional($materials->find($productionOrder->lamination_name))->material_name ?? 'N/A' }}</p>
            </div>
            <div class="row">
                <p class="field-size"><strong>Lamination Gum Name:</strong>{{ optional($materials->find($productionOrder->lamination_gun_name))->material_name ?? 'N/A' }}</p>
    ...
    <?php if ($categoryValue != 'Plastic Jumbo Roll' ): ?>
        <div class="personal-info details-space" id="RewindingProduction">
            ...
            <div class="row first-section">
                ...
                <p class="field-size"><strong>Bharti:</strong> {{  $productionOrder->rewinding_bharti??'N/A' }}</p>
            </div>
            <div class="row">
    ...
    <div class="personal-info details-space" id="packingDetails">
        ...
        <div class="row first-section">
            <p class="field-size"><strong>Bharti:</strong> {{ old('rewinding_pipe', $productionOrder->packing_bharti??'N/A') }}</p>
            <p class="field-size"><strong>Packing Name:</strong> {{ $productionOrder->packing_name??'N/A'}}</p>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <?php if ($categoryValue === 'Plastic Roll' || $categoryValue === 'Plastic Jumbo Roll' ): ?>
                <p class="field-size"><strong>Colour:</strong> {{ old('packing_colour', $productionOrder->packing_colour??'N/A') }}</p>
            <?php endif ?>
        </div>
        <div class="row last-section">
            <p class="field-size"><strong>Sticker:</strong> {{ $productionOrder->packing_sticker?? 'N/A' }}</p>
    ...
    <div class="personal-info details-space" id="stitchingproduction">
        ...
        <div class="row">
            ...
            <p class="field-size"><strong>Bharti:</strong> {{ $productionOrder->sticching_bharti?? 'N/A'}}</p>
        </div>
        <div class="row last-section">
...
<script>
    ...
    if ( category == '4') {
            ...
            if(category == '1'){
                ...
                $('#stitchingproduction h6').text('Step 5 - Silai');
