    ...
    <form  id="productionOrderEditForm" action="{{ route('production_order.update', $productionOrder->id) }}" method="post">
        ...
        <div class="outer card">
            <div class="heading-btn">
                ...
                <span class="addsupplier-section-heading">#{{$productionOrder->id}}</span>
                    ...
                    <div class="row form-inp-group">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select name="lamination_type" id="lamination_type" class="custom-select d-block w-100 form-select-grps form-control select2">
                                ...
                                <option value="Strip" {{ old('lamination_type', $productionOrder->lamination_type) == 'Strip' ? 'selected' : '' }}>Strip</option>
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select name="extrusion_recipe" id="extrusion_recipe" class="custom-select d-block w-100 form-select-grps form-control select2">
                                ...
                                @foreach($recipemasters as $recipemaster)
                                    <option class="product_nm_inpp" value="{{ $recipemaster->id }}" {{ old('extrusion_recipe', $productionOrder->extrusion_recipe) == $recipemaster->id ? 'selected' : '' }}>{{ $recipemaster->recipe_name }}</option>
                                @endforeach
                            </select>
            ...
            <div class="upload-file-sec">
                    <div class="row customer-files-sec">
                        <div class="row form-inp-group">
                            ...
                            <input type="text" class="form-control @error('rewinding_bharti') is-invalid @enderror @if(old('rewinding_bharti')) is-valid @endif" name="rewinding_bharti" id="rewinding_bharti" placeholder="Bharti" value="{{ old('rewinding_bharti', $productionOrder->rewinding_bharti ?? '') }}">
                            @error('rewinding_bharti')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-lg-3 mb-3" hidden>
                            ...
                            <input type="text" class="form-control @error('rewinding_material_name') is-invalid @enderror @if(old('rewinding_material_name')) is-valid @endif" name="rewinding_material_name" id="rewinding_material_name" placeholder="Rewinding Material Name" value="{{ old('rewinding_material_name', $productionOrder->rewinding_material_name ?? '') }}">
                            @error('rewinding_material_name')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                            <div class="col-lg-3 mb-3">
                                ...
                                <option value="">Select</option>
                                    @foreach($stickers as $sticker)
                                        <option value="{{$sticker->id}}"  data-id="{{$sticker->id}}"{{ old('rewinding_sticker', $productionOrder->rewinding_sticker) == $sticker->material_name ? 'selected' : '' }}>{{$sticker->material_name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row form-inp-group">
                            ...
                            <div class="col-lg-3 mb-3">
                                ...
                                @foreach($materials as $material)
                                    ...
                                    <option value="{{$material->material_name}}"  data-id="{{$material->id}}"{{ old('packing_name', $productionOrder->packing_name) == $material->material_name ? 'selected' : '' }}>{{$material->material_name}}</option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-lg-3 mb-3">
                                <label class="heading-content" for="packing_sticker">Sticker</label>
                                <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="packing_sticker" name="packing_sticker">
                                <option value="">Select</option>
                                    @foreach($stickers as $sticker)
                                        <option value="{{$sticker->material_name}}"  data-id="{{$sticker->id}}"{{ old('packing_sticker', $productionOrder->packing_sticker) == $sticker->material_name ? 'selected' : '' }}>{{$sticker->material_name}}</option>
                                    @endforeach
                                </select>
                ...
                <div class="row customer-files-sec">
                    <div class="row form-inp-group">
                        <div class="col-lg-3 mb-3">
                            ...
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <input type="text" class="form-control @error('packing_weight') is-invalid @enderror @if(old('packing_weight')) is-valid @endif" name="packing_weight" id="packing_weight" value=""hidden>
                        </div>
                        <div class="col-lg-3 mb-3 colourData">
                        ...
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="sticching_packing_name" name="sticching_packing_name">
                                <option value="">Select</option>
                                @foreach($materials as $material)
                                    <option value="{{$material->material_name}}"  data-id="{{$material->id}}"{{ old('sticching_packing_name', $productionOrder->sticching_packing_name) == $material->material_name ? 'selected' : '' }}>{{$material->material_name}}</option>
                                @endforeach
                            </select>
...
<div id="data-container"
     data-products="{{ json_encode($productdatas) }}"
></div>
@endsection
@section('js')
...
<script>
    ...
    $(document).ready(function() {
        function updateCategory() {
            ...
            console.log('Category Matches 1 or 2');
            console.log('Category:', category);

            $('#laminationProduction').css('display', 'block');
            $('#extrusionProduction').css('display', 'none');

            $('#RewindingProduction h6').text('Step 2 - Rewinding');
            $('#packingDetails h6').text('Step 3 - Packing Details');
            $('#stitchingproduction h6').text('Step 4 - Silai');
            $('#pipeSize').css('display', 'none');
            $('.colourData').hide();
        } else if (category == '5') {
            $('.colourData').hide();
        } else {
            console.log('Category does not match 1 or 2');
            console.log('Category:', category);
            $('.colourData').show();
            $('#laminationProduction').css('display', 'none');
            $('#extrusionProduction').css('display', 'block');

            $('#extrusionProduction h6').text('Step 1 - Extrusion');
            $('#RewindingProduction h6').text('Step 2 - Rewinding');
            $('#packingDetails h6').text('Step 3 - Packing Details');
            $('#stitchingproduction h6').text('Step 4 - Silai');
            $('#pipeSize').css('display', 'block');
        }
    ...
    document.addEventListener('DOMContentLoaded', function () {
       ...
       var rewindingQtyInRollsInput = document.getElementById('rewinding_qty_in_rolls');
        ...
        $('#bundle_quantity').on('input', function() {
            console.log('datattat');
            var packingWeightVal = parseInt($('#packing_weight').val()) || 0; 
            var rollsInOneBDL = parseInt($('#roll_in_one_bdl').val()) || 0; // Ensure it's a number
            var requiredData = parseInt($('#bundle_quantity').val()) || 0; // Ensure it's a number
    ...
    const makeToOrdertoal = document.getElementById('make_to_order_total_bundle');
        const makeToOrderpending = document.getElementById('make_to_order_pending_bundle');
    function toggleFields() {
        if (orderTypeSelect.value === 'Make to Order') {
            ...
            makeToOrdertoal.classList.remove('d-none');
            makeToOrderpending.classList.remove('d-none');
          ...
          //  skuSelect.addEventListener('change', skuChangeHandler);
            ...
            // $('#extrusion_colour').val('');
            // $('#rewinding_colour').val('');
            // $('#packing_colour').val('');
            // $('#sticching_colour').val('');
            ...
            makeToOrdertoal.classList.add('d-none');
            makeToOrderpending.classList.add('d-none');
            productTypeSelect.addEventListener('change', productTypeChangeHandler);
            $('#extrusion_colour, #rewinding_colour, #packing_colour, #sticching_colour').on('keyup', function() {
                var colorName = $(this).val(); // Get the value typed in the input
                // Update all other inputs with the same value
                $('#extrusion_colour').val(colorName);
                $('#rewinding_colour').val(colorName);
                $('#packing_colour').val(colorName);
                $('#sticching_colour').val(colorName);
            });
    ...
    function productTypeChangeHandler() {
                ...
                if (materialId && materialId !== 'null') {
                    $.ajax({
                        ...
                        error: function(response) {
                            ...
                            // If stickerId is null, undefined, or empty, deselect the option
                            document.getElementById('sticching_packing_name').value = '';
                            document.getElementById('packing_name').value = '';
                            // console.log('No stickerId provided, deselecting packing sticker option');
                        }
                ...
                rewindingMaterialNameInput.value =productData.packing_material_name || '';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (selectedCompanyId) {
        ...
        productTypeSelect.addEventListener('change', function () {
            ...
            .replace(':salesOrderValue', salesOrderValue),
                ...
                extrusionQtyOfPackingInput.value =((packingWeightVal * qty_in_rolls *response.pending_bdl_kg).toFixed(2));
                        ...
                        if (stickerId && stickerId !== 'null') {
                            $.ajax({
                                ...
                                error: function(response) {
                                    console.error('Error fetching orders:', response);
                                    document.getElementById('packing_sticker').value = '';  // Deselect if error occurs
                                    document.getElementById('rewinding_sticker').value = '';  // Deselect if error occurs
                                }
                            });
                        } else {
                            // If stickerId is null, undefined, or empty, deselect the option
                            document.getElementById('packing_sticker').value = '';
                            document.getElementById('packing_sticker').value = '';
                            console.log('No stickerId provided, deselecting packing sticker option');
                        }
                        var selectedOption = $('#product_type option:selected');
                        ...
                        if(category == '1' || category == '2' || category == '5'){
                            ...
                            const colourValue = response.colour || "";
                            rewindingColourInput.value = colourValue;
                            stitchingColourInput.value = colourValue;
                            packingColourInput.value = colourValue;
                            extrusionColourInput.value = colourValue;
    ...
    //     // If the element is visible and not hidden via the d-none class, then validate
