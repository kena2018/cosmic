                        ...
                        <div class="options input-dgn">
                            <div class="row form-inp-group">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="serial_number" class="form-control input-form-content @error('serial_number') is-invalid @enderror @if(!empty(old('serial_number'))) is-valid @endif" id="serial_number" placeholder="Enter Serial Number" value="{{$formattedsrnumberId}}" readonly>
                ...
                <div class="table-responsive table-designs">
                    <table class="table active all">
                        ...
                        <tr class="table-select-data customerorder-table">
                            ...
                            <td class="table-data-contents">
                                <select class="custom-select d-block w-100 form-select-grp select2 material-select" id="packing_material_type1" name="packing_material_type[]">
                                    <option value="">Select</option>
                                    @foreach($materials as $material)
                                        <option value="{{$material->material_name}}"  {{ old('packing_material_type.0') == $material->material_name ? 'selected' : '' }}>{{$material->material_name}}</option>
                                    @endforeach
                                </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function appendNewSKUOption(text, value, datarolls1bdl,datapackingmaterialname, dataPmt, dataBdl, dataBharti, dataBagbox, dataId, datarate, product,datamaterial) {
            var skuDropdowns = $('tbody select.sku-select');
...
function formatIndianCurrency(amount) {
    ...
    document.querySelectorAll('input[name="roll_counte[]"], input[name="total[]"]').forEach(input => {
        ...
        $('.add_product').click( function(){
            ...
            var materialOptions = $('tbody select.material-select').first().html();
        ...
        $('tbody').on('change', '.product-select', function() {
            ...
            // var packingMaterialName = productData.packing_material ? productData.packing_material.material_name || '' :
            console.log('6666');
            console.log('packingMaterialName:',packingMaterialName);
            var selectElement = $('#packing_material_type1'); 
            ...
            options.each(function() {
                if ($(this).val() === packingMaterialName) {
                    $(this).prop('selected', true);  // Set the matching option as selected
                }
            });
