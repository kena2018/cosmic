...
<div class="main-outer">
    <div class="outer card">
        ...
        <form method="post" action="{{route('customerOrder.store')}}" id="newOrderCustomer">
            @csrf
            <div class="heading-btn">
                    ...
                    <div class="options input-dgn">
                                ...
                                <select class="custom-select d-block w-100 form-select-grp select2 @error('customer') is-invalid @enderror @if(old('customer')) is-valid @endif" name="customer" id="customer_add_data">
                                    <option value="">Select Company</option>
                                        @foreach($customers as $customer_data)
                                            <option value="{{$customer_data->id}}" data-no="{{$customer_data->contect}}" data-add="{{$customer_data->address1}}" {{ old('customer') == $customer_data->id ? 'selected' : '' }}>{{$customer_data->company_name}}</option>
                                        @endforeach
                                </select>
                        ...
                        <div class="row form-inp-group">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="contact" class="form-control input-form-content @error('contact') is-invalid @enderror @if(!empty(old('contact'))) is-valid @endif" id="contactSelect" placeholder="Enter Phone Number" value="{{old('contact')}}" >
                                @error('contact')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="heading-content" for="price_list">Price List</label>
                                <select class="custom-select d-block w-100 form-select-grp select2 @error('price_list') is-invalid @enderror @if(old('price_list')) is-valid @endif" name="price_list" id="price_list">
                                    <option value="">Select Price List</option>
                                    @foreach($pricelists as $pricelist)
                                    
                                    <!-- <option>{{$pricelist}}</option> -->
                                        <option value="{{ $pricelist->id }}" data-id="{{ $pricelist->id }}"{{ old('price_list') == $pricelist->id ? 'selected' : '' }}>
                                            {{ $pricelist->list_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <!-- <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="delivery_date" class="form-control input-form-content @error('delivery_date') is-invalid @enderror @if(!empty(old('delivery_date'))) is-valid @endif" id="delivery_date" placeholder="" value="{{old('delivery_date')}}" >
                                @error('delivery_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div> -->
                            <div class="col-md-4 mb-3">
                                <label class="heading-content" for="delivery_date">Delivery Date<span style="color: red;">*</span></label>
                                <input 
                                    type="date" 
                                    name="delivery_date" 
                                    class="form-control input-form-content @error('delivery_date') is-invalid @enderror @if(!empty(old('delivery_date'))) is-valid @endif" 
                                    id="delivery_date" 
                        ...
                        <div class="row form-inp-group">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control input-form-content @error('shipping_address') is-invalid @enderror @if(!empty(old('shipping_address'))) is-valid @endif" id="shipping_address" name="shipping_address" placeholder="Enter Delivery interaction" value="{{old('shipping_address')}}">
                                ...
                                <div class="col-md-9 mb-3">
                                    ...
                                    <select class="transform-select d-block w-100 form-select-grp select2 @error('packing_name') is-invalid @enderror @if(old('packing_name')) is-valid @endif" name="packing_name" id="packing_name">
                                        ...
                                        @foreach($transforms as $transform)
                                            <option value="{{$transform->id}}"{{ old('packing_name') == $transform->id ? 'selected' : '' }}>{{$transform->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <!-- <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control input-form-content @error('order_id') is-invalid @enderror @if(!empty(old('order_id'))) is-valid @endif" id="order_id" name="order_id" placeholder="Advance" value="{{$formattedLastOrderId}}"readonly>
            ...
            <div class="table-responsive table-designs">
                <table class="table active all">
                    <thead>
                        ...
                        <th class="product_name_inp"><a href="javascript:void(0);" title="">Product Name<span style="color: red;">*</span></a></th>
                    ...
                    <tr class="table-select-data customerorder-table">
                        ...
                        <td class="table-data-contents">
                            <select class="custom-select d-block w-100 form-select-grp select2 product-select" id="product" name="product[]">
                                <option value="">Select</option>
                                @foreach($products as $product)
                                
                                <option value="{{$product->id}}" data-rolls1bdl="{{$product->rolls_in_1_bdl}}" data-packingmaterialname="{{ optional($product->packingMaterial)->material_name ?? null }}"data-rate="{{$product->rate}}" data-product="{{$product}}" data-bdl="{{$product->bdl_kg}}" data-bharti="{{$product->bharti}}" data-bagbox="{{$product->number_of_bags_per_box}}"  data-id="{{$product->id}}"{{ old('product.0') == $product->id ? 'selected' : '' }}>{{$product->product_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <!-- <td class="table-data-contents">
                            <div class="d-flex align-items-center dropdown-cursour">
                                <button class="btn color-select dropdown-toggle d-flex align-items-center" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                    Select
                                </button>
                                ...
                                <input type="hidden" name="color[]" class="selected-color" id="color"value="{{old('color.0')}}">
                            </div>
                            @error('color.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td> -->
                        <td class="table-data-contents">
                            <div class="d-flex align-items-center dropdown-cursour">
                        ...
                        <td class="color-data-tb">
                            <div class="add-icon-btn color_data">
                                <svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-plus color_data" viewBox="0 0 16 16"><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/></svg>
                            </div>
                        </td>
                        <!-- <td class="table-data-contents">
                            <input type="text" name="sticker_name[]" id="sticker_name_0" value="{{old('sticker_name.0')}}"class="order-input @error('sticker_name.0') is-invalid @enderror @if(!empty(old('sticker_name.0'))) is-valid @endif">
                            @error('sticker_name.0')<div class="invalid-feedback">{{ $message }}</div>@enderror    
                        </td> -->
                        <td class="table-data-contents">
                            <select class="custom-select d-block w-100 form-select-grp select2 sticker-select" id="sticker_name" name="sticker_name[]">
                                <option value="">Select</option>
                                @foreach($stickers as $sticker)
                                    <option value="{{$sticker->id}}"  data-id="{{$sticker->id}}"{{ old('sticker_name.0') == $sticker->id ? 'selected' : '' }}>{{$sticker->material_name}}</option>
                                @endforeach
                            </select>
                            @error('sku.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        ...
                        <td class="table-data-contents">
                            <input type="text" name="packing_material_type[]" value="{{old('packing_material_type.0')}}"class="order-input @error('packing_material_type.0') is-invalid @enderror @if(!empty(old('packing_material_type.0'))) is-valid @endif">
                            @error('packing_material_type.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        <td class="table-data-contents total-input">
                            <input type="text" name="bdl_kg[]" value="{{old('bdl_kg.0')}}"class="order-input @error('bdl_kg.0') is-invalid @enderror @if(!empty(old('bdl_kg.0'))) is-valid @endif">
                            @error('bdl_kg.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        <td class="table-data-contents">
                            <input type="text" name="bharti[]" value="{{old('bharti.0')}}"class="order-input @error('bharti.0') is-invalid @enderror @if(!empty(old('bharti.0'))) is-valid @endif" readonly>
                            @error('bharti.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        <td class="table-data-contents">
                            <input type="text" name="unit_box[]" value="{{old('unit_box.0')}}" class="order-input @error('unit_box.0') is-invalid @enderror @if(!empty(old('unit_box.0'))) is-valid @endif"readonly>
                            @error('unit_box.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        <td class="table-data-contents">
                            <input type="text" name="roll_counte[]" value="{{old('roll_counte.0')}}"class="order-input @error('roll_counte.0') is-invalid @enderror @if(!empty(old('roll_counte.0'))) is-valid @endif"readonly>
                        ...
                        <td class="table-data-contents total-input ">
                            <input type="text" name="total[]" value="{{old('total.0')}}"readonly  class="order-input @error('total.0') is-invalid @enderror @if(!empty(old('total.0'))) is-valid @endif">
                            @error('total.0')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </td>
                        <td class="table-data-contents">
                            <input type="text" name="remark[]" value="{{old('remark.0')}}"class="order-input @error('remark.0') is-invalid @enderror @if(!empty(old('remark.0'))) is-valid @endif">
                    ...
                    <div class="upload---file-sections custmr-notes-sec">
                        <div class="row form-inp-group">
                            <div class="">
                                ...
                                <textarea class="notes-area" name="customer_notes" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
...
<!-- <script src="{{ asset('public/assets/js/createpage.js')}}"></script> -->
 <!-- <script>
     document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add an event listener to the input field to trigger the datepicker when clicked
        dateInput.addEventListener('click', function() {
            this.showPicker(); // Opens the calendar dropdown
        });
    });
 </script> -->
<script type="text/javascript">  
    $(document).ready(function () {
        ...
        //     },
        //     messages: {
        //         name: 'Please enter a valid color.'
        //     }
        // });
        ...
        $('#newOrderCustomer').validate({
            ...
            messages: {
                ...
                'bdl_kg[]': {
                    ...
                    min: "The bdl kg value must be at least 0."
                },
                'bharti[]': {
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            colorDropdowns.each(function() {
                var newListItem = `
                    <li class="d-flex align-items-center justify-content-between dropdown-item" data-color-value="${value}">
                        ...
                        <span class="table-group-icons edit-icon-tag delete-color"></span>
                    </li>
                `;
        ...
        //             // Append the new option to the select element
        //             $this.append(new Option(text, value,true,true));
        //            // $this.append(new Option(response.newOption.text, response.newOption.value,true, true,));
        ...
        $('#customer_add_data').on('change', function() {
            ...
            // Fetch the last price list ID of the selected customer via AJAX
            $.ajax({
                url: '{{ route('last-price-list', ':customerId') }}'.replace(':customerId', customerId),
                type: 'GET',
                success: function(response) {
                    if (response.price_list) {
                        // Set the price list dropdown to the fetched price list ID
                        $('#price_list').val(response.price_list).trigger('change');
                    } else {
                        // If there's no last price list, reset the dropdown
                        $('#price_list').val('').trigger('change');
                    }
                },
                error: function(xhr) {
                    console.log('Error fetching last price list:', xhr);
                }
            });
        ...
        //     var formattedAmounttotal = "0";
            
        // //     var formattedAmount = roll_count ? formatIndianCurrency(roll_count) : "0";
        // // var formattedAmounttotal = total ? formatIndianCurrency(total) : "0";
        // // var formattedAmountrate = rate ? formatIndianCurrency(rate) : "0";
        //     if (roll_count) {
        //       formattedAmount = roll_count; 
        //     }
        //     if (total) {
        //         // console.log('total:'total);
        //       formattedAmounttotal = total; 
        //     }
        //     if (rate) {
        //         // console.log('rate:'rate);
        //       formattedAmountrate = rate; 
        //     }
        ...
        //     // $('#amount').find('input[name="amount"]').val(amount.toFixed(2));
        // }
    ...
    // Format amounts using custom formatting function if needed
    row.find('input[name="roll_counte[]"]').val(formatIndianCurrency(roll_count));
    row.find('input[name="total[]"]').val(formatIndianCurrency(total));
}

// Attach an event listener to recalculate when the value of bdl_kg[] changes
$(document).on('input', 'input[name="bdl_kg[]"], input[name="rate[]"], input[name="bharti[]"], input[name="unit_box[]"]', function() {
    // Find the closest row to pass into the update function
    var row = $(this).closest('tr');  // Assumes fields are in a table row
    updateRollsInBdl(row);
});

// Example formatIndianCurrency function for formatting (you can customize as needed)
function formatIndianCurrency(amount) {
    return new Intl.NumberFormat('en-IN').format(amount);
}

        document.querySelector('form').addEventListener('submit', function(event) {
    // Select all input fields with numbers that were formatted
    document.querySelectorAll('input[name="roll_counte[]"], input[name="total[]"]').forEach(input => {
        ...
        $('.add_product').click( function(){
            ...
            var sticerOptions = $('tbody select.sticker-select').first().html();
            ...
            var newField = `<tr class="table-select-data customerorder-table">
                        ...
                        <td class="product-data-tb">
                            ...
                            <td class="table-data-contents"><input class="order-input" type="text" name="packing_material_type[]" id="packing_material_type_${colorSelectCounter}" value=""></td>
        ...
        function updateAllProductRates() {
            ...
            $('tbody .product-select').each(function() {
                ...
                var rate = '';
                console.log('sku chakjfvkjf', sku);
        ...
        $('tbody').on('change', '.product-select', function() {
            ...
            // var rate ='';
            var rate = '';
            console.log('rate chack sku', sku);
            productDetailsArray.forEach(function(productprice) {
                ...
                if (sku == productprice.product_id) {
                    ...
                    // var rate = selectedProduct.data('rate');
                    // console.log('No match for productID:', productprice.product_id);
                }
                // if (productData && productData.id == productprice.product_id) {
                //      rate = productprice.special_rate !== null ? productprice.special_rate : productprice.discount_rate;
                // } else {
                //     // var rate = selectedProduct.data('rate');
                //     // console.log('No match for productID:', productprice.product_id);
            ...
            // console.log('fjsdfsdfjksdffjk',rollsInOneBDL);
            ...
            // var packingMaterialName = productData.packing_material ? productData.packing_material.material_name || '' :
            console.log('6666');
            console.log(packingMaterialName);
        ...
        $('tbody').on('keyup', 'input[name="bdl_kg[]"]', function() {
            var row = $(this).closest('tr');
            updateRollsInBdl(row);
        });
    ...
    $(document).on('click', '.delete-color', function() {
        ...
        var listItem = $(this).closest('li'); // Target the closest <li> element containing the color
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        listItem.remove();
                        // $('svg[data-color-name="' + colorName + '"]').closest('li').remove();
                    } else {
        ...
        $('#transformForm').on('submit', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.newOption) {
                        $('#packing_name').append(new Option(response.newOption.text, response.newOption.value,true,true));
                    }
                    // Optionally, update the table or other parts of the page with the new data
                },
                error: function(xhr) {
    ...
    <div class="modal-dialog">
        <div class="modal-content model-data modal-details-width">
            ...
            <form class="needs-validation" action="{{ route('customers.add')}}" method="post"  id="customersForm">
                ...
                <hr class="company-popup-section-border">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-1">
...
<div class="modal fade" id="" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content model-data">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Customer Order List ?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
             <p class="modal-para">Are you sure you want to cancel this order ?</p>
            </div>
            <div class="modal-footer cstmr-odr-popup">
                <div class="btn-sec btn_group">
                    <div class="button-1">
                        <a href="{{route('customerOrder.index')}}" class="delete-customer delete-customerOrder" id="role_id" data-id="">OK</a>
                    </div>
                </div>
            </div>
        </div>
