...
@extends('layouts.app')
@section('navbarTitel', 'Add Manufacturing Order')
@section('content')
                ...
                <div class="row col-12 customer-files-sec">
                    <div class="row form-inp-group">
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control input-form-content" id="name" placeholder="Add Product Name" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="heading-content"  for="name">Status</label>
                            <input type="text" class="form-control input-form-content" id="name" placeholder="Add Your Status" required>
                        </div>
                    </div>
                    <div class="row form-inp-group">
                        <div class="col-md-4 mb-4">
                            <label class="heading-content"  for="name">SKU</label>
                            <input type="text" class="form-control input-form-content" id="name" placeholder="Add SKU" required>
                        </div>
                        <div class="col-md-4 mb-4">
                            <label class="heading-content"  for="number">Colour</label>
                            <input type="text" class="form-control input-form-content" id="name" placeholder="Add Colour" required>
                        </div>
                        <div class="col-md-4 mb-4">
                    ...
                    <div class="row form-inp-group">
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" class="form-control input-form-content" id="name" placeholder="" required>
                        </div>
                        <div class="col-md-4 mb-4">
                        ...
                        <div class="order-btn-grp">
                            <div class="btn-sec btn_group">
                                <div class="button-3 cta_btn">
                                    <button type="submit" class="">Add PriceList</button>
                                </div>
