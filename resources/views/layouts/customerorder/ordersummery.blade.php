@extends('layouts.app')
@section('navbarTitel', 'Order Summery')
@section('content')
                ...
                <div class="button-grp-custordr">
                    ...
                    <div class="btn-sec btn_group">
                        <div class="button-3 cta_btn icon-btn">
                            <a href="javascript:void(0)" class="primary-button ">Edit Order</a>
                        </div>
                        <div class="button-1 cta_btn icon-btn">
                            <a href="javascript:void(0)" class="primary-button ">Mark as Shipped</a>
                        </div>
                        <div class="button-2 cta_btn icon-btn">
                            <a href="javascript:void(0)" class="primary-button ">Cancel Order</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive table-designs">
                    ...
                    <table class="table active all">
                        <tr class="history-content">
                            ...
                            <td class="history-content-headingg"><a class="table-anc-content" href="javascript:void(0);" title="">16:28:45 </a></td>
                            <td class="history-content-headingg"><a class="table-anc-content" href="javascript:void(0);" title="">11-08-2023</a></td>
                        </tr>
                        <tr class="history-content">
                            <td class="history-content-heading"><a href="javascript:void(0);" title="">Staff Member marked order as Delivered</a></td>
                            <td class="history-content-headingg"><a class="table-anc-content" href="javascript:void(0);" title="">16:28:45 </a></td>
