                    ...
                    <tbody class="reports-table-data">
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content prodct-report-data" href="javascript:void(0);">Daily Production Reports</a>
                            </td>
                            <td class="table-data-contents">
                        ...
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content" href="javascript:void(0);">Rewinding Reports</a>
                            </td>
                            <td class="table-data-contents">
                                <a class="table-anc-content" href="javascript:void(0);">Packing Material Usage</a>
                            </td>
                            <td class="table-data-contents">
                        ...
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content prodct-report-data" href="javascript:void(0);">Packing Reports</a>
                            </td>
                            <td class="table-data-contents">
                        ...
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content prodct-report-data" href="javascript:void(0);">Extruder Report</a>
                            </td>
                            <td class="table-data-contents">
                        ...
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content" href="javascript:void(0);">Stiching Report</a>
                            </td>
                        </tr>
                        <tr>
                            <td class="table-data-contents">
                                <a class="table-anc-content" href="javascript:void(0);">Lamination Report</a>
                            </td>
